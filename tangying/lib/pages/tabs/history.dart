                ...
                itemBuilder: (context, index) {
                  ...
                  if (item['createdate'] == null) {
                    ...
                    return Column(
                      ...
                      children: [
                        Text(
                          'Date: ${item['createdate']!.toLocal()} (Count: ${item['samedatecount'] ?? 0})',
                        ),
                        ListView.builder(
                          shrinkWrap: true,
                          physics: NeverScrollableScrollPhysics(),
                          itemCount: _list.length - index,
                          itemBuilder: (subContext, subIndex) {
                            if (subIndex >= _list.length) return Container();
                            var subItem = _list[index + subIndex];
                            if (subItem['createdate'] != item['createdate'])
                              return Container();
                            return ListTile(
                              title: Text('score: ${subItem['score']}'),
                            );
                          },
                        ),
                      ],
